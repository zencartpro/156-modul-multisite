...
if(isset($_GET['action'])) {
  switch($_GET['action']) {
    ...
    ?>
      ...
      $config_query = $db->Execute('SELECT cg.configuration_group_title, cg.language_id, c.configuration_key,c.configuration_value,c.configuration_title
...
<script type="text/javascript" src="includes/shBrushXml.js"></script>
