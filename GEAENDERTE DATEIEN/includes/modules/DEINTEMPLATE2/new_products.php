 ...
 * @version $Id: new_products.php for Multisite 2019-09-28 20:31:22Z webchills $
 */
...
if ($new_products_query != '') $new_products = $db->ExecuteRandomMulti(cat_filter($new_products_query), MAX_DISPLAY_NEW_PRODUCTS);
