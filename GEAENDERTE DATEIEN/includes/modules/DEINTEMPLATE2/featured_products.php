 ...
 * @version $Id: featured_products.php for Multisite 2019-09-28 20:59:21Z webchills $
 */
...
if ($featured_products_query != '') $featured_products = $db->ExecuteRandomMulti(cat_filter($featured_products_query), MAX_DISPLAY_SEARCH_RESULTS_FEATURED);
