 ...
 * @version $Id: specials_index.php for Multisite 2019-09-28 20:59:21Z webchills $
 */
...
if ($specials_index_query != '') $specials_index = $db->ExecuteRandomMulti(cat_filter($specials_index_query), MAX_DISPLAY_SPECIAL_PRODUCTS_INDEX);
